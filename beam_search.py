...
def beam_search_right(token_ids, beam_size, suffix='', breadth=100):
 ...
 def display_word(toks):
  s = ''
  for tok in toks:
    is_suffix = tokenizer.startswith('##')
